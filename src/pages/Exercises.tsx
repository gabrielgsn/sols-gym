...
import { MUSCLE_GROUPS, MUSCLE_GROUP_LABELS, type Exercise, type MuscleGroup } from '../db/schema';
  ...
  return (
    <div className="card flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-1">
        ...
        >
          {MUSCLE_GROUPS.map((g) => (
            <option key={g} value={g} className="bg-slate-900">{MUSCLE_GROUP_LABELS[g]}</option>
          ))}
        </select>
      </div>
      <div className="flex flex-col gap-1">
